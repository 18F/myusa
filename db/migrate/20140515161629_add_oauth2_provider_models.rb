class AddOauth2ProviderModels < ActiveRecord::Migration
  # When we were using Songkick, we ran this as the migration, but we need to
  # remove it because we are no longer using the Songkick gem. So that migrations
  # don't break, we are including the tables.
  # def up
