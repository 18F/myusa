...
describe 'OAuth' do
  ...
  let(:client_application_scopes) { 'profile.email profile.title profile.first_name profile.middle_name profile.last_name profile.phone_number profile.suffix profile.address profile.address2 profile.zip profile.gender profile.marital_status profile.is_parent profile.is_student profile.is_veteran profile.is_retired' }
